	...
	if(isset($_SESSION["shopping_cart"])){
      ...
      foreach($_SESSION["shopping_cart"] as $keys => $values){
  			if($values["item_id"] == $_GET["id"]){
  				$_SESSION["shopping_cart"][$keys]['item_quantity'] += (int)$_POST["quantity"];
  			}
  		}
		}
	}
	...
	if($_GET["action"] == "delete"){
		foreach($_SESSION["shopping_cart"] as $keys => $values){
			if($values["item_id"] == $_GET["id"]){
				...
				echo '<script>window.location="c_pricing.php"</script>';
			}
		}
	}
}
                            ...
                            <div class="main-menu d-none d-lg-block">
                                <nav>
                                    <ul id="navigation">
                                        ...
                                        <li><a class="active" href="c_pricing.php">PRICING</a></li>
                              ...
                              <div class="details-info">
                                <div class="row">
                                  ...
                                  <div class="col-xl-4 col-md-4">
                                    <form method="post" action="c_pricing.php?action=add&id=<?php echo $row['s_id'];  ?>">
                                    <div class="single-address text-center" style="border-bottom: solid red;margin-bottom:50px">
                                      ...
                                      <span style="font-family:rupee;font-size:20px"><?php echo $row['s_description'];  ?> Rs./Kg. </span><p><?php echo $row['s_prize'];  ?></p>
                                      <input type="text" name="quantity" value="1" class="form-control" />
                                      <input type="hidden" name="hidden_name" value="<?php echo $row["s_title"]; ?>" />
			                                <input type="hidden" name="hidden_price" value="<?php echo $row["s_prize"]; ?>" />
                              ...
                              <div class="row">
                                ...
                                <div class="col-xl-4 col-md-4">
                                  ...
                                  <div class="single-address text-center" style="border-bottom: solid red;margin-bottom:50px">
                                    ...
                                    <h4><?php echo $row['s_title'];  ?></h4>
                                    <span style="font-family:rupee;font-size:20px"><?php echo $row['s_description'];  ?> Rs./Piece </span><p><?php echo $row['s_prize'];  ?></p>
                                    <input type="text" name="quantity" value="1" class="form-control" />
                                    <input type="hidden" name="hidden_name" value="<?php echo $row["s_title"]; ?>" />
                                    <input type="hidden" name="hidden_price" value="<?php echo $row["s_prize"]; ?>" />
                                    <input type="submit" name="add_to_cart" style="margin-top:5px;" class="btn btn-success" value="Add to Cart" />
            ...
            <div class="progress-table-wrap">
              <div class="progress-table">
                ...
                <?php
                  ...
                  ?>
                <div class="table-row">
                  <div class="percentage align-items-center justify-content-center"><?php echo $count++; ?></div>
                  <div class="percentage align-items-center justify-content-center"><?php echo $values["item_name"]; ?></div>
                  <div class="percentage align-items-center justify-content-center"><?php echo $values["item_quantity"]; ?></div>
                  <div class="percentage align-items-center justify-content-center">Rs. <?php echo $values["item_price"]; ?></div>
                  <div class="percentage align-items-center justify-content-center"><?php echo number_format($values["item_quantity"] * $values["item_price"], 2);?></div>
                  <div class="percentage align-items-center justify-content-center"><a href="c_pricing.php?action=delete&id=<?php echo $values['item_id']; ?>"> Remove </a></div>
                </div>
                <?php
