        ...
        <div class="row">
          <div class="col-xl-7 offset-xl-1 col-lg-7">
            <div class="slider-content">
              ...
              <h3>Best On Demand Dry Cleaning and Loundry Services</h3>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="single-slider bg-img-2">
      <div class="container">
        <div class="row">
          <div class="col-xl-7 offset-xl-1 col-lg-7">
            <div class="slider-content">
              <p>When Your Clothes Need To Stand On Their Own.</p>
              <h3>Best Past Of Laundry Day Is Conserving Your Energy</h3>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="row">
          <div class="col-xl-7 offset-xl-1 col-lg-7">
            <div class="slider-content">
              ...
              <h3>We Care For Clothes You Wear</h3>
            </div>
          </div>
        </div>
      </div>
